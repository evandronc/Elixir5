defmodule DungeonCrawl.CLI.Main do
  ...
  defp crawl(character, rooms) do
    ...
    # Evandro
    # Shell.info("Rooms number: #{Enum.count(rooms)}")
    #
  ...
  defp handle_action_result({_, :exit}), do: Shell.info("You found the exit. You won the game. Congratulations!")
  defp handle_action_result({character, :forward}), do: crawl(character, DungeonCrawl.Room.all())
  defp handle_action_result({character, :rest}), do: crawl(character, DungeonCrawl.Room.all())
end
